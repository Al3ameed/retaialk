    ...
    public function getProducts()
    {
        try {
            ...
            if (isset($_GET['id'])) {
                ...
                $AllProducts = Products::where('brand_id', $brandId)->where('active', 1)->orderBy('sorting_no', 'asc')->latest('updated_at')->get();
                $array = array();
                ...
                $AllProducts = Products::where('brand_id', $brand->id)->where('active', 1)->orderBy('sorting_no', 'asc')
                    ->latest('updated_at')
                    ->get();
                $array = array();
