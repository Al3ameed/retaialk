...
class CollectionController extends Controller
{
    ...
    public function itemsList()
    {
        ...
        $products = Products::where('active', 1)->where('is_variant', 0)
            ->select('id', 'name_en as name', 'item_code', 'brand_id')->latest('updated_at')->get();
            //            ->isVariant()
//            ->get();
