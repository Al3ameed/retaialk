                        ...
                        <div class="col-sm-3">
                          ...
                          <div class="col-sm-3">
                              ...
                              @else
                                  ...
                                  <label for="image">Size Chart Image (Optional): <span style="color:red;">*</span></label>
                                  <input type="file" name="chartImages"  id="upload_single" class="form-group" >
                              @endif
                          </div>
                      </div>
                        <div class="row">
                            <div class="form-group  col-lg-6 col-sm-6 col-xs-9 col-md-6 col-xl-6">
                                <ul id="sortable" class="sortable">
...
{{--                                                </div>--}}
                      ...
                      <div class="row">
                        <div class="col-sm-32"><button onclick="disableBtn(this)" id="btnSubmit" type="submit" style="margin-left: 12px" class="btn btn-primary">Save</button></div>
                      </div>
                  </div>
              </div>
