...
<!--                                                  <td>@if(isset($address->address_phone)){{$address->address_phone}} @endif</td>                                                    
 -->                                                 <td>@if(isset($address->district_id) && array_key_exists($address->district_id, $districts) &&  $address->district_id !=0 && $districts[$address->district_id]){{$districts[$address->district_id]}} @endif</td>           
   ...
   <!-- <td>@if(isset($address->apartment_no)){{$address->apartment_no}} @endif</td>  -->
                                       ...
                                       <!--  @foreach($user->address as $address)
                                        ...
                                        @if(isset($address->street))
                                            ...
                                            <br>
                                            @endif
                                            @if(isset($address->district_id) && array_key_exists($address->district_id, $districts) && $address->district_id !=0 && $districts[$address->district_id])
