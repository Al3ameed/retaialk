                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-12" style="margin-top: 0px;">
                                                <div class='input-group date' id='' style="display: inline;  text-align: right">
                                                  <input class="form-control" pattern="^[0-9]+$" id="building_number" name="building_no" min="0" placeholder="" required="required" type="number"   value="{{ $address->building_no }}" />
                                                </div>
                                            </div>
                                        </div>
                              <div class="col-lg-3">
                                ...
                                <div class="col-lg-12" style="margin-top: 0px">
                                  <div class='input-group date' style="display: inline;" id=''>
                                    <input class="form-control" min="0"  id="floor_number" step="1" name="floor_no"
                                    ...
                                    <!-- <select name="floor_number" id="floor_number" class="form-control" title="الطابق">
                                      ...
                                      @endfor
                                          ...
                                          <div class="col-lg-3">
                                              ...
                                              <div class="col-lg-12" style="margin-top: 0px">
                                                  <div class='input-group date' style="display: inline;" id=''>
                                                  <input class="form-control" min="0"  id="apartment_number"  name="apartment_no"
