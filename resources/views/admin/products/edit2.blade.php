                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                              <div class="col-lg-12">
                                                  ...
                                                  for="from">Name: <span style="color:red;">*</span>
                                                  </label>
                                              </div>
                                              <div class="col-lg-12" style="margin-top: 0px">
                                                ...
                                                <div class="col-lg-4">
                                                  <div class='input-group date' style="display: inline;"
                                                   id=''>
                                                      ...
                                                      value="{{$key}}:{{$variant}}"  class="form-control">
                                                  ...
                                                  <input type='text' required
                                                   name="variation_item{{$i}}[]"
                                                    id="variation_item{{$i}}"
                                                    class="variation_item{{$i}}"
                                                     value="{{$k}}:{{$v}}" hidden=""  class="form-control">
                                                  @endforeach
                                              </div>
                                          </div>
                                        </div>
