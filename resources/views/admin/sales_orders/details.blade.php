 ...
 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12" style="margin-top: 20px;">
                                ...
                                <div class="col-sm-3"><label for="">Customer Note</label></div>
                                <div class="col-sm-7">
                                    <div class='input-group date' style="display: inline;" id=''>
                                        <textarea disabled="disabled"
                                                  class="form-control">@if(isset($sales_order->note) ) {{$sales_order->note}} @endif
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="col-sm-3">
                                    <label style="margin-bottom: 0;" class="form-group" for="from">Shipment Company
                                    </label>
                                </div>
                                <div class="col-sm-6" style="margin-top: 0px">
                                    <div class='input-group date' style="display: inline;" id=''>
                                        <input type='text' value="{{optional($sales_order->shipment)->shipment_company}} " disabled="disabled"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- @endif -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="col-sm-3">
                                    <label style="margin-bottom: 0;" class="form-group" for="from">Discount Value
                                    </label>
                                </div>
                                <div class="col-sm-6" style="margin-top: 0px">
                                    <div class='input-group date' style="display: inline;" id=''>
                                        <input type='text' value="{{$promocode_value}} " disabled="disabled"
                                               class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="col-sm-3">
                                    <label style="margin-bottom: 0;" class="form-group" for="from">Discount Code
                                    </label>
                                </div>
                                <div class="col-sm-6" style="margin-top: 0px">
                                    <div class='input-group date' style="display: inline;" id=''>
                                        <input type='text' value="{{$sales_order->discount_code}} " disabled="disabled"
                                               class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="col-sm-6" style="margin-top: 0px">
                                    <div class='input-group date' style="display: inline;" id=''>
                                        <input type='text'
                                               value="{{$sales_order->shipping_rate}} LE"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="col-sm-3">
                                    <label style="margin-bottom: 0;" class="form-group" for="from">Grand Total Before Discount
                                    </label>
                                </div>
                                <div class="col-sm-6" style="margin-top: 0px">
                                    <div class='input-group date' style="display: inline;" id=''>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="col-sm-3">
                            <label class="form-group" for="from">Add Note
                            </label>
                        </div>
                        <div class="col-sm-6">
                            <div class='input-group date' style="display: inline;" id=''>
