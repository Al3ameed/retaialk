                    ...
                    <div class="card card-block">
                      ...
                      <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="name" value="" type="text" class="form-control" name="name" required>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="email" value="" type="email" class="form-control" name="email" required>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select onchange="getSelectRoleVal(this)" name="role" value="{{old('role')}}" id="role" class="form-control" required="required">
...
<script src="{{url('public/admin/plugins/datatables/responsive.bootstrap4.min.js')}}"></script>
   ...
   function getSelectRoleVal(ele) {
       if (ele.value == 3) {
           console.log('here');
           $('#related_warehouses').removeAttr('disabled');
       } else {
